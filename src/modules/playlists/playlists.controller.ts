...
export class MyPlaylistsController {
  ...
  create(@CurrentUser() user: { id: string }, @Body() dto: CreatePlaylistDto) {
...
export class PlaylistsController {
  ...
  detail(@Param('id') id: string, @CurrentUser() user: { id: string } | undefined) {
  ...
  update(@Param('id') id: string, @CurrentUser() user: { id: string }, @Body() dto: UpdatePlaylistDto) {
  ...
  @Post(':id/tracks')
  @UseGuards(AccessTokenGuard)
  @UsePipes(new ZodValidationPipe(addTrackToPlaylistSchema))
  addTrack(
    @Param('id') id: string,
